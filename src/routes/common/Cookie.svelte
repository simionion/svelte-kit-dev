<script lang="ts">
	import { keyFocusedDB } from '$lib/client/storage.ts';

	const cookieStorageKey = 'cookie-policy-accepted';

	const cookieStorage = keyFocusedDB(cookieStorageKey);

	function dismissCookieNotice() {
		const cookieNotice = document.getElementById('cookies-simple-with-icon-and-dismiss-button');
		cookieNotice?.remove();
		cookieStorage.set(true);
	}
</script>

{#if !cookieStorage.get()}
	<div
		id="cookies-simple-with-icon-and-dismiss-button"
		class="fixed bottom-0 right-0 z-[60] mx-auto w-full p-6 sm:max-w-sm"
	>
		<!-- Card -->
		<div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
			<div class="flex gap-x-4">
				<svg
					class="h-auto w-8 flex-shrink-0"
					width="72"
					height="63"
					viewBox="0 0 72 63"
					fill="none"
				...
				>
					...
					<mask
						...
						fill="currentColor"
						class="text-gray-800 dark:fill-gray-200"
					>
						<ellipse
							rx="1.09811"
							ry="0.738034"
				...
				<p class="text-sm text-gray-800 dark:text-gray-200">
					By browsing this website, you accept our <a
						class="inline-flex items-center gap-x-1.5 font-medium text-blue-600 decoration-2 hover:underline"
				...
				<div>
					<button
						...
						type="button"
						class="inline-flex rounded-full p-2 text-gray-500 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-gray-50 dark:text-gray-400 dark:hover:bg-gray-600"
